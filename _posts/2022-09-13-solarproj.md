...
<script type="module" defer>
    "use strict";let style=document.createElement("style");style.type="text/css",style.innerHTML="body {margin: 0;padding: 0;} #text {z-index: 3;pointer-events: none;} canvas {position: fixed;width: 100vw;height: 100vh;overflow: hidden;z-index: 2;} input {color:'red';position:fixed;z-index:3;};#gui { z-index:4; };",document.getElementsByTagName("head")[0].appendChild(style);
