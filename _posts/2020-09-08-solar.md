...
You can alter a planet's colors like this. Example:
```javascript

space.pluto.color.set('red');
...
space.pluto.position = rotateVector(space.pluto.position, 0, 17.14 * Math.PI / 180, 270 * Math.PI / 180);
